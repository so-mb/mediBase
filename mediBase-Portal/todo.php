...
<head>
    <meta charset="utf-8">
    <title>mediBase Portal - To Do List</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="todo.php" class="nav-item nav-link active"><i class="fa fa-list-check me-2"></i>To Do</a>
